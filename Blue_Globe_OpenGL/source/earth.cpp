...
void init(){
  std::string vshader = R"(./shaders/vshader.glsl)";
  std::string fshader = R"(./shaders/fshader.glsl)";
  ...
  std::string earth_img = R"(./images/world.200405.3.jpg)";
  std::string cloud_img = R"(./images/cloud_combined.jpg)";
  std::string night_img = R"(./images/BlackMarble.jpg)";
  std::string perlin_img = R"(./images/perlin_noise.jpg)";
